...
class ManpowerUsageListView extends StatefulWidget {
  const ManpowerUsageListView({super.key});
...
class _ManpowerUsageListViewState extends State<ManpowerUsageListView> {
  ...
  void initState() {
    ...
    context.read<ManpowerUsageBloc>().add(const LoadManpowerUsages());
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: BlocBuilder<ManpowerUsageBloc, ManpowerUsageState>(
              builder: (context, state) {
                ...
                if (state.usages.isEmpty) {
                  return const Center(
                    child: Text('No manpower usage records found'),
                  );
                }
        ...
        children: [
          Expanded(
            child: TextField(
              ...
              onChanged: (value) {
                context.read<ManpowerUsageBloc>().add(SearchChanged(value));
              },
            ),
          ),
