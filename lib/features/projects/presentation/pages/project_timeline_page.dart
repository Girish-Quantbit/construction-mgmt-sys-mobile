...
//                 child: Row(
//                   children: [
//                     SizedBox(width: sizeContextOf(context, 200)), // Space for project names
...
//                       // Project Name
//                       Positioned(
//                         left: sizeContextOf(context, 0),
//                         top: sizeContextOf(context, 0),
//                         bottom: sizeContextOf(context, 0),
//                         width: 200,
//                         child: Container(
//                           padding: EdgeInsets.symmetric(horizontal: sizeContextOf(context, 16)),
...
//                       // Grid background
//                       Positioned(
//                         left: sizeContextOf(context, 200),
//                         right: sizeContextOf(context, 0),
//                         top: sizeContextOf(context, 0),
//                         bottom: sizeContextOf(context, 0),
//                         child: Row(
